...
function readProductsTemplate(data, keywords) {
  var read_products_html =
    ...
    keywords +
    `' name='keywords' class='form-control product-search-keywords' placeholder='Search products...' />
  ...
  if (data.paging) {
    ...
    if (data.paging.first != "") {
      read_products_html +=
        "<li><a data-page='" + data.paging.first + "'>First Page</a></li>";
    }
    ...
    if (data.paging.last != "") {
      read_products_html +=
        "<li><a data-page='" + data.paging.last + "'>Last Page</a></li>";
    }
