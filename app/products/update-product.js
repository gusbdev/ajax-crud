$(document).ready(function () {
  ...
  $(document).on("click", ".update-product-button", function () {
    ...
    $.getJSON(
      "http://localhost/teste-brunksker/api/product/read_one.php?id=" + id,
      function (data) {
        ...
        $.getJSON(
          "http://localhost/teste-brunksker/api/category/read.php",
          function (data) {
...
<div id='read-products' class='btn btn-primary pull-right m-b-15px read-products-button'>
  ...
  $(document).on("submit", "#update-product-form", function () {
    ...
    $.ajax({
      url: "http://localhost/teste-brunksker/api/product/update.php",
      type: "POST",
